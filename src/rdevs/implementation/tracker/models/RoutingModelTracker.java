...
public class RoutingModelTracker {
	...
	/*
	 * Este m�todo deber�a mostrar rengl�n a rengl�n los eventos que han salido desde este
	 * routing tracker, con toda su informaci�n.
	 */
	...
	/*
	 * Este m�todo deber�a tomar los datos como argumento y generar el evento que se manda desde
	...
	/*
	 * Este m�todo deber�a tomar los datos como argumento y generar el evento que se acepta en 
	 * este modelo proveniente de un source espec�fico (con todo lo que implica).
	 */
